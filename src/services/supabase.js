...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlxdWxjYnl3cGhqZXdlbmFsbmV4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzY3OTYwODgsImV4cCI6MjA1MjM3MjA4OH0.zLSUvcFNCzehoUizP-R9w5X8EFmJlV7cZEnD6X9vr3E"; 

export const supabase = createClient(supabaseUrl, supabaseKey);

export const uploadImage = async (file) => {
    const { data, error } = await supabase.storage
      .from("results") // Upewnij się, że nazwa bucketu jest poprawna
